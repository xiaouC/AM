    ...
    public void deleteOldMessages() {
        main_activity.yy_show_alert_dialog.showAlertDialog( R.layout.alert_attention, new YYShowAlertDialog.onAlertDialogHandler() {
            public void onInit( AlertDialog ad, View view ) {
                String text1 = "        All old messages that have been listened to will be deleted. Are you sure you wish to continue?";
            ...
            main_activity.yy_show_alert_dialog.showAlertDialog( R.layout.alert_attention, new YYShowAlertDialog.onAlertDialogHandler() {
                public void onInit( AlertDialog ad, View view ) {
                    ...
                    if( msg_info.getMsgType() == 0 ) {
                        text1 = String.format( "        Are you sure that you want to delete the message you have received from %s without listening to the message first?", msg_info.getMsgName() );
                    } else {
